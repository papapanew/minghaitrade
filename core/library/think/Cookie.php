...
class Cookie
{
    ...
    protected static $config = [
        ...
        'samesite'  => 'Lax', // 推荐 Lax 或 Strict，跨域需求用 None
    ];
            ...
            if (\PHP_VERSION_ID < 70300) {
                ...
                setcookie(
                    $name, $value, [
                        ...
                        'samesite' => $config['samesite'] ? $config['samesite'] : 'Lax'
                    ]
                );
            }
        }
