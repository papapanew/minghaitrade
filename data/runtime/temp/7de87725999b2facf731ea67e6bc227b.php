<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"./application/admin/template/language\pack_add.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\layout.htm";i:1757153768;s:94:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\theme_css.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\footer.htm";i:1757135753;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page pb10" style="min-width: auto;box-shadow:none;">
    <form class="form-horizontal" id="post_form" action="<?php echo url('Language/pack_add'); ?>" method="post">
        <div class="ncap-form-default pb10">
            ...
            <dl class="row">
                ...
                <dd class="opt" style="width: auto;">
                    <input type="text" name="value[<?php echo $vo['mark']; ?>]" value="" class="input-txt">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
...
<script type="text/javascript">
    ...
    function checkForm(){
        ...
        $.ajax({
            type : 'post',
            url : "<?php echo url('Language/pack_add', ['_ajax'=>1]); ?>",
