<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/template/index\welcome.htm";i:1757153768;s:94:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\theme_css.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\footer.htm";i:1757135753;}*/ ?>
<!doctype html>
<html>
<head>
...
<div id="explanation_welcome" style="margin:10px 10px 0px 10px; display: none;">
    <?php if(intval($ddos_scan_last_time) + ($ddos_scan_day * 86400) < getTime()): ?>
    <div class="explanation" style="color: rgb(44, 188, 163); background-color: #fff!important;  margin-top: 10px;">
        <div class="title checkZoom" data-type="4">
            <span title="不再提示" style="display: block;"></span>
        </div>
        <ul>
            <li style="color: red;">
                温馨提示：欢迎使用<?php echo $version; ?>版本，建议到安全中心给系统做一次安全检测，是否有安全隐患需要处理<a href="<?php echo url('Security/index'); ?>">【点击进入】</a>
            </li>
        </ul>
    </div>
    ...
    <div class="explanation" style="color: rgb(44, 188, 163); background-color: #fff!important;  margin-top: 10px;">
        ...
        <ul>
            ...
            <a href="javascript:void(0);" data-href="<?php echo url('Admin/admin_edit', ['id'=>\think\Session::get('admin_info.admin_id'),'iframe'=>1]); ?>" onclick="openFullframe(this, '管理员-修改密码');">【修改密码】</a>提高安全性。</li>
        </ul>
    </div>
    <?php endif; if(empty($system_explanation_welcome_5)): ?>
    <div class="explanation" style="color: rgb(44, 188, 163); background-color: #fff!important;  margin-top: 10px;">
        <div class="title checkZoom" data-type="5">
            <span title="不再提示" style="display: block;"></span>
        </div>
        <ul>
            <li style="color: red;">
                风险提示：经定时扫描，发现系统核心文件存在被篡改风险，请到安全中心处理并进行深度扫描 <?php echo MyDate('Y-m-d H:i',$ddos_scan_last_time); ?> <a href="<?php echo url('Security/index', ['noreset'=>1]); ?>">【点击进入】</a>
            </li>
        </ul>
    </div>
    <?php endif; ?>
...
<script type="text/javascript">
    $(function(){
        if ($('#explanation_welcome div.explanation').length > 0) {
            $('#explanation_welcome').show();
        }
    });
</script>
<div class="warpper">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td id="td_upgrade_msg">
                                        ...
                                        <a href="javascript:void(0);" id="a_upgrade" data-version="" data-max_version="" data-curent_version="<?php echo (isset($sys_info['curent_version']) && ($sys_info['curent_version'] !== '')?$sys_info['curent_version']:'v1.0.0'); ?>" data-iframe="workspace" title="" data-tips_url="<?php echo url('Upgrade/setPopupUpgrade'); ?>" data-upgrade_url="<?php echo url('Upgrade/OneKeyUpgrade'); ?>" data-check_authority="<?php echo url('Upgrade/check_authority'); ?>" data-php_servicemeal="<?php echo (isset($php_servicemeal) && ($php_servicemeal !== '')?$php_servicemeal:0); ?>"><?php if(!empty($security_patch)): ?>正在版本检测中……<?php else: if($upgrade == 'true'): ?>正在版本检测中……<?php else: ?>已是最新版<?php endif; endif; ?></a>
                                    </td>
                                    <td class="gray_bg">当前版本：</td>
                                    <td><?php echo (isset($sys_info['curent_version']) && ($sys_info['curent_version'] !== '')?$sys_info['curent_version']:'v1.0.0'); ?></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?><a href="https://www.eyoucms.com/buy/" target="_blank" style="color: #454545;">盗版必究</a><?php else: ?>正版软件<?php endif; ?>&nbsp;
                                        <?php if(!is_internal_network()): ?>
                                        <a href="javascript:void(0);" onclick="top.openItem('Index|authortoken|is_force|1');">校验</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php if(!empty($is_eyou_authortoken) && !is_internal_network()): ?>
                                <tr>
                ...
                <div class="system_section_con">
                    ...
                    <div class="sc_warp" id="system_warp" style="display: block;padding-bottom: 20px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            ...
                            <tr>
                                <td class="gray_bg"><?php echo (isset($sys_info['dbtype']) && ($sys_info['dbtype'] !== '')?$sys_info['dbtype']:''); ?> 版本：</td>
