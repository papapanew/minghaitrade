<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:55:"./application/admin/template/system\customvar_index.htm";i:1757153768;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\layout.htm";i:1757153768;s:94:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\theme_css.htm";i:1757135753;s:88:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\system\bar.htm";i:1757135753;s:89:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\page.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\footer.htm";i:1757135753;}*/ ?>
<!doctype html>
<html>
<head>
...
<style type="text/css">
    .customvar_attr_input_type_5 button.layui-btn{
        margin-top: -4px;
        height: 30px;
        line-height:30px;
    }
                                        ...
                                        <?php else: ?>
                                            <span class="span_showhide span_attr_input_type">
                                                ...
                                                <?php elseif($vo['attr_input_type'] == 3): ?>
                                                    上传图片
                                                <?php elseif($vo['attr_input_type'] == 5): ?>
                                                    多媒体类型
                                                <?php else: ?>
                                                    单行文本
                                                <?php endif; ?>
                                            ...
                                            <select name="attr_input_type[]" class="input_showhide none" onchange="change_attr_input_type(this);">
                                                ...
                                                <option value="5" <?php if($vo['attr_input_type'] == '5'): ?>selected<?php endif; ?>>多媒体类型</option>
                                ...
                                <td style="width: 100%">
                                    <div style="padding-left: 15px;" class="ncap-form-default">
                                        ...
                                        <?php switch($vo['attr_input_type']): case "1": break; case "2": ?>
                                            ...
                                            <?php break; case "5": ?>
                                                <span class="customvar_attr_input_type_5 input_showhide" style="display: none;">
                                                    <input type="text" class="input-txt" id="<?php echo $vo['attr_var_name']; ?>_media_url" name="attr_value[]" value="<?php echo (isset($vo['value']) && ($vo['value'] !== '')?$vo['value']:''); ?>" style="width: 400px !important;" >
                                                    <input type="file" id="<?php echo $vo['attr_var_name']; ?>_upload_media" onchange="upload_media_20210408(this, '<?php echo $vo['attr_var_name']; ?>')" style="display: none;">
                                                    <?php if('qny' == $upload_conf['upload_flag']): ?>
                                                    <button type="button" class="layui-btn" id="<?php echo $vo['attr_var_name']; ?>_qny_upload_media" onclick="$('#<?php echo $vo['attr_var_name']; ?>_upload_media').attr('data-type', 'qny').trigger('click');">七牛云上传</button>
                                                    <?php elseif('oss' == $upload_conf['upload_flag']): ?>
                                                    <button type="button" class="layui-btn" id="<?php echo $vo['attr_var_name']; ?>_oss_upload_media" onclick="$('#<?php echo $vo['attr_var_name']; ?>_upload_media').attr('data-type', 'oss').trigger('click');">oss上传</button>
                                                    <?php elseif('cos' == $upload_conf['upload_flag']): ?>
                                                    <button type="button" class="layui-btn" id="<?php echo $vo['attr_var_name']; ?>_cos_upload_media" onclick="$('#<?php echo $vo['attr_var_name']; ?>_upload_media').attr('data-type', 'cos').trigger('click');">cos上传</button>
                                                    <?php elseif('aws' == $upload_conf['upload_flag']): ?>
                                                    <button type="button" class="layui-btn" id="<?php echo $vo['attr_var_name']; ?>_aws_upload_media" onclick="$('#<?php echo $vo['attr_var_name']; ?>_upload_media').attr('data-type', 'aws').trigger('click');">亚马逊S3上传</button>
                                                    <?php else: ?>
                                                    <button type="button" class="layui-btn" id="<?php echo $vo['attr_var_name']; ?>_local_upload_media" onclick="$('#<?php echo $vo['attr_var_name']; ?>_upload_media').attr('data-type', 'local').trigger('click');">本地上传</button>
                                                    <?php endif; ?>
                                                </span>
                                            <?php break; default: ?>
                                ...
                                <td class="">
                                    <div class="w150 tl">
                                        ...
                                        <?php endif; if(is_check_access('System@customvar_del') == '1'): if($main_lang == $admin_lang): ?>
                                            <a class="btn red" href="javascript:void(0);" data-id="<?php echo $vo['id']; ?>" onClick="customvar_del(this);" <?php if($global['web_recycle_switch'] == '1'): ?> data-deltype="del" <?php else: ?> data-deltype="pseudo" <?php endif; ?>>删除</a>
                                            <?php endif; endif; ?>
                                        <a class="btn blue" href="javascript:void(0);" onclick="copyToClipBoard('<?php echo $vo['attr_var_name']; ?>', '<?php echo $vo['attr_var_title']; ?>')">标签调用</a>
                                    </div>
                                </td>
                                <td class="sort">
                                    <div class="w60 tc">
                                        <span class="span_showhide span_sort_order"><?php echo $vo['sort_order']; ?></span>
                                        <input type="text" name="sort_order[]" value="<?php echo $vo['sort_order']; ?>" class="input_showhide" style="display: none;" onkeyup="this.value=this.value.replace(/[^\d]/g,'');" onpaste="this.value=this.value.replace(/[^\d]/g,'')">
                                    </div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    function customvar_add(){
        ...
        html += '            <input type="text" name="sort_order[]" value="100" class="input_showhide" onkeyup="this.value=this.value.replace(/[^\\d]/g,\'\');" onpaste="this.value=this.value.replace(/[^\\d]/g,\'\')">';
        html += '        </div>';
        html += '    </td>';
        html += '</tr>';
    ...
    function change_attr_input_type(obj)
    {
        ...
        if (2 == attr_input_type) {
            ...
            var upload_flag = "<?php echo (isset($upload_conf['upload_flag']) && ($upload_conf['upload_flag'] !== '')?$upload_conf['upload_flag']:'local'); ?>";
            html += '<span class="customvar_attr_input_type_5 input_showhide">';
            html += '    <input type="text" class="input-txt" id="'+tr_id+'_media_url" name="attr_value[]" value="" style="width: 400px !important;" >';
            html += '    <input type="file" id="'+tr_id+'_upload_media" onchange="upload_media_20210408(this, \''+tr_id+'\')" style="display: none;">';
            if ('qny' == upload_flag) {
                html += '    <button type="button" class="layui-btn" id="'+tr_id+'_qny_upload_media" onclick="$(\'#'+tr_id+'_upload_media\').attr(\'data-type\', \'qny\').trigger(\'click\');">七牛云上传</button>';
            } else if ('oss' == upload_flag) {
                html += '    <button type="button" class="layui-btn" id="'+tr_id+'_oss_upload_media" onclick="$(\'#'+tr_id+'_upload_media\').attr(\'data-type\', \'oss\').trigger(\'click\');">oss上传</button>';
            } else if ('cos' == upload_flag) {
                html += '    <button type="button" class="layui-btn" id="'+tr_id+'_cos_upload_media" onclick="$(\'#'+tr_id+'_upload_media\').attr(\'data-type\', \'cos\').trigger(\'click\');">cos上传</button>';
            } else if ('aws' == upload_flag) {
                html += '    <button type="button" class="layui-btn" id="'+tr_id+'_aws_upload_media" onclick="$(\'#'+tr_id+'_upload_media\').attr(\'data-type\', \'aws\').trigger(\'click\');">亚马逊S3上传</button>';
            } else {
                html += '    <button type="button" class="layui-btn" id="'+tr_id+'_local_upload_media" onclick="$(\'#'+tr_id+'_upload_media\').attr(\'data-type\', \'local\').trigger(\'click\');">本地上传</button>';
            }
            html += '</span>';
        } else {
            html += '<input type="text" name="attr_value[]" value="" class="input_showhide input-txt">';
    ...
    function customvar_save_one(obj){
        ...
        var sort_order = trObj.find(('input[name*=sort_order]')).val();
        ...
        $.ajax({
            ...
            data : {attr_id:attr_id,attr_var_name:attr_var_name,attr_name:attr_name,attr_input_type:attr_input_type,attr_value:attr_value,type_id:attr_type_id,sort_order:sort_order,_ajax:1},
            dataType : 'json',
...
//                        window.location.reload();
                    ...
                    trObj.find(".span_sort_order").html(sort_order);
     ...
     * @param limit 条数
     */
    function copyToClipBoard(attr_var_name, attr_var_title) {
        ...
        contentdiv += '<dd><input type="text" style=" width:400px;margin-bottom:10px;" value="{'+'eyou:global name=\''+attr_var_title+'\' /}"></dd>'
        height = '250px';
...
<script>
    // 上传媒体文件
    function upload_media_20210408(e, attr_var_name){
        var data_type = $(e).attr('data-type');
        if ('qny' == data_type) {
            // 七牛云上传
            qny_upload_media(e, attr_var_name);
        } else if ('oss' == data_type) {
            // OSS上传
            oss_upload_media(e, attr_var_name);
        } else if ('cos' == data_type) {
            // COS上传
            cos_upload_media(e, attr_var_name);
        } else if ('aws' == data_type) {
            // 亚马逊S3上传
            aws_upload_media(e, attr_var_name);
        } else {
            // 本地上传
            local_upload_media(e, attr_var_name);
        }
    }

    function judgeExtMedia_20210408(ext) {
        var type = "<?php echo (isset($upload_conf['ext']) && ($upload_conf['ext'] !== '')?$upload_conf['ext']:'ra,ram,vqf,wma,mp3,mid,cd,wave,aiff,au,mpeg-4,midi,vqf,amr,wav,mp4,swf,mov,rm,dat,mpeg,mpg,avi,wmv,rmvb,mp4,asf,3gp,mkv,flv,f4v,webm,ogg,ogv,m4a,m3u8'); ?>";
        type = type.replace(/,/g,"|");
        var extArr = [];
        extArr = type.split("|");
    ...
    // 七牛云
    function qny_upload_media(e, attr_var_name) {
        // 获取文件路径名
        ...
        var ext = judgeExtMedia_20210408(fileExt);
        if (ext == -1) {
            showErrorMsg('仅支持<?php echo $upload_conf['ext']; ?>格式,可在附件设置中修改');
            return false;
        }

        // 验证上传大小
        size = parseInt("<?php echo $upload_conf['filesize']; ?>");
        if (file.size > size) {
                ...
                if (1 == res1.code) {
                    ...
                    $.ajax({
                        ...
                        xhr: function () {
                            ...
                            if (myXhr.upload) {
                                myXhr.upload.addEventListener('progress', function(e){
                                    ...
                                    $("#"+attr_var_name+"_qny_upload_media").text('上传中...'+process+"%");
                                });
                            }
                            return myXhr;
                        },
                        success: function(res2) {
                            layer.closeAll();
                            $("#"+attr_var_name+"_qny_upload_media").text('上传成功');
                            setTimeout(function() {
                                $("#"+attr_var_name+"_qny_upload_media").text('七牛云上传');
                            }, 2000);
                            var video_url = res1.data.domain + "/" + res2.key;
                            $("#"+attr_var_name+"_media_url").val(video_url);
                        },
                        error: function(e) {
                            layer.closeAll();
    ...
    //OSS
    function oss_upload_media(e, attr_var_name) {
        // 获取文件路径名
        var file = $(e)[0].files[0];
                    ...
                    $.ajax({
                        ...
                        xhr: function () {
                            ...
                            if (myXhr.upload) {
                                myXhr.upload.addEventListener('progress', function(e){
                                    ...
                                    $("#"+attr_var_name+"_oss_upload_media").text('上传中...'+process+"%");
                                });
                            }
                            return myXhr;
                        },
                        success : function(data) {
                            ...
                            if (res) {
                                ...
                                $("#"+attr_var_name+"_oss_upload_media").text('上传成功');
                                setTimeout(function() {
                                    $("#"+attr_var_name+"_oss_upload_media").text('oss上传');
                                }, 2000);
                                var video_url = res1.data.domain + "/" + key;
                                $("#"+attr_var_name+"_media_url").val(video_url);
                            } else {
                                $("#"+attr_var_name+"_oss_upload_media").text('上传失败');
                                setTimeout(function() {
                                    $("#"+attr_var_name+"_oss_upload_media").text('oss上传');
                                }, 2000);
                            }
    ...
    //COS
    function cos_upload_media(e, attr_var_name) {
        // 获取文件路径名
        var file = $(e)[0].files[0];
        ...
        $.ajax({
            ...
            xhr: function () {
                ...
                if (myXhr.upload) {
                    myXhr.upload.addEventListener('progress', function(e){
                        ...
                        $("#"+attr_var_name+"_cos_upload_media").text('上传中...'+process+"%");
                    });
                }
                return myXhr;
            },
            success: function(res) {
                layer.closeAll();
                if (1 == res.code) {
                    $("#"+attr_var_name+"_cos_upload_media").text('上传成功');
                    $("#"+attr_var_name+"_media_url").val(res.data.url);
                } else {
                    $("#"+attr_var_name+"_cos_upload_media").text('上传失败');
                }
                setTimeout(function() {
                    $("#"+attr_var_name+"_cos_upload_media").text('cos上传');
                }, 2000);
            },
            error: function(e) {
                layer.closeAll();
    ...
    //亚马逊S3
    function aws_upload_media(e, attr_var_name) {
        // 获取文件路径名
        var file = $(e)[0].files[0];
        ...
        $.ajax({
            type: 'post',
            url: '/index.php?m=plugins&c=Aws&a=aws_upload&_ajax=1',
            data: formData,
            contentType: false,
            processData: false,
            dataType: 'json',
            xhr: function () {
                ...
                if (myXhr.upload) {
                    myXhr.upload.addEventListener('progress', function(e){
                        ...
                        $("#"+attr_var_name+"_aws_upload_media").text('上传中...'+process+"%");
                    });
                }
                return myXhr;
            },
            success: function(res) {
                layer.closeAll();
                if (1 == res.code) {
                    $("#"+attr_var_name+"_aws_upload_media").text('上传成功');
                    $("#"+attr_var_name+"_media_url").val(res.data.url);
                } else {
                    $("#"+attr_var_name+"_aws_upload_media").text('上传失败');
                }
                setTimeout(function() {
                    $("#"+attr_var_name+"_aws_upload_media").text('亚马逊S3上传');
                }, 2000);
            },
            error: function(e) {
                layer.closeAll();
    ...
    // 本地上传
    function local_upload_media(e, attr_var_name){
        // 获取文件路径名
        var file = $(e)[0].files[0];
        ...
        $.ajax({
            ...
            xhr: function () {
                ...
                if (myXhr.upload) {
                    myXhr.upload.addEventListener('progress', function(e){
                        ...
                        var total = e.total;
                        process = parseInt(curr / total * 100);
                        $("#"+attr_var_name+"_local_upload_media").html('上传中...'+process+"%");
                    });
                }
                return myXhr;
            },
            success: function (res) {
                ...
                if ("SUCCESS" == res.state) {
                    $("#"+attr_var_name+"_local_upload_media").html('上传成功');
                    setTimeout(function() {
                        $("#"+attr_var_name+"_local_upload_media").html('本地上传');
                    }, 2000);
                    $("#"+attr_var_name+"_media_url").val(res.url);
                } else {
                    res = JSON.parse(res);
