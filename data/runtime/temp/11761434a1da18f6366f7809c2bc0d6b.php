<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/template/admin\login.htm";i:1757135752;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\footer.htm";i:1757135753;}*/ ?>
<!DOCTYPE html>
...
<html>
    <head>
        ...
        <link href="/public/static/admin/css/login.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css" />
        <link href="/public/static/admin/font/css/iconfont.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css" />
        <link href="/public/static/admin/css/diy_style.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css" />
        <style type="text/css">
            body {
                background:#6f8489 url('<?php echo (handle_subdir_pic($global['web_loginbgimg']) ?: '/public/static/admin/loginbg/login-bg-1.png'); ?>') left top no-repeat;
                background-size: 100%;
            }
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php if(in_array($third_login, ['EyouGzhLogin','userGzhLogin'])): ?>
