<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:43:"./application/admin/template/system\web.htm";i:1757135754;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\layout.htm";i:1757153768;s:94:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\theme_css.htm";i:1757135753;s:88:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\system\bar.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\footer.htm";i:1757135753;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="ncap-form-default">
                ...
                <div id="div_web_status_close" class="<?php if(!isset($config['web_status']) OR empty($config['web_status'])): ?>none<?php endif; ?>">
                    ...
                    <dl class="row dl_web_status_mode <?php if(empty($config['web_status_mode']) || 2 != $config['web_status_mode']): ?>none<?php endif; ?>" id="dl_web_status_mode_2">
                        ...
                        <dd class="opt">
                            <input id="web_status_tpl" name="web_status_tpl" value="<?php if(isset($config['web_status_tpl'])): ?><?php echo (isset($config['web_status_tpl']) && ($config['web_status_tpl'] !== '')?$config['web_status_tpl']:''); else: ?>http://www.31744.minghaitrade.com/public/close.html<?php endif; ?>" class="input-txt" type="text" placeholder="关闭后，访问网站显示的个性化页面，public/close.html" autocomplete="off"/>
            ...
            <div class="ncap-form-default">
                <dl class="row">
                    ...
                    <dd class="opt ui-web_title ui-text">
                        ...
                        <?php if(file_exists(ROOT_PATH.'weapp/Ai/template/admin_tpl/system/web_ai_tdk_btn.htm')): ?>
                            模板文件不存在: ./weapp/Ai/template/admin_tpl/system/web_ai_tdk_btn.htm
                        <?php endif; ?>
                    ...
                    <table cellspacing="0" cellpadding="0" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <th abbr="article_title" axis="col3" class="w10">
                                <div class="tc">
                                    第三方代码
                                    <?php if(function_exists('is_template_opt') && !is_template_opt()): ?>
