<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"./application/admin/template/language\pack_index.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\layout.htm";i:1757153768;s:94:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\theme_css.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\footer.htm";i:1757135753;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
        <div class="mDiv pt0">
            <div class="ftitle">
                ...
                <div class="fbutton">
                    <a href="javascript:void(0);" data-href="<?php echo url('Language/pack_add'); ?>" onclick="openFullframe(this, '新增语言包变量', '600px', '480px');">
                        <div class="add">
                ...
                <div class="fbutton">
                    <a href="javascript:void(0);" data-href="<?php echo url('Language/pack_batch_add'); ?>" onclick="openFullframe(this, '批量新增语言包变量', '600px', '550px');">
                        <div class="adds">
                            <span>批量新增</span>
                        </div>
                    </a>
            ...
            <form class="navbar-form form-inline" action="<?php echo url('Language/pack_index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                ...
                <div class="sDiv">
                    <?php if(is_check_access('Language@pack_syn') == '1'): ?>
                    ...
                    <?php endif; ?>
                    <div class="sDiv2">
                        <input type="text" size="30" name="keywords" value="<?php echo \think\Request::instance()->param('keywords'); ?>" class="qsbox" placeholder="变量值搜索...">
                        ...
                        <tr>
                            ...
                            <td class="operation">
                                <div class="w160 tc">
                                    ...
                                    <a href="javascript:void(0);" data-href="<?php echo url('Language/pack_edit',array('id'=>$vo['id'])); ?>" onclick="openFullframe(this, '编辑模板语言变量', '600px', '480px');" class="btn blue">编辑</a>
                                    <i></i>
                                    <?php endif; if(is_check_access('Language@pack_del') == '1'): if($vo['is_syn'] != '1'): ?>
                                        <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Language/pack_del'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this);">删除</a>
                                        <i></i>
                                        <?php endif; endif; ?>
