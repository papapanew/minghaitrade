<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"./application/admin/template/language\index.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\layout.htm";i:1757153768;s:94:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\theme_css.htm";i:1757135753;s:90:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\language\bar.htm";i:1757135753;s:91:"D:\phpstudy_pro\WWW\www.31744.minghaitrade.com\application\admin\template\public\footer.htm";i:1757135753;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="mDiv pt0">
            <div class="ftitle">
                <?php if($main_lang == $admin_lang): if(is_check_access('Language@add') == '1'): ?>
                    <div class="fbutton">
                        <a href="javascript:void(0);" data-href="<?php echo url('Language/add'); ?>" onclick="openFullframe(this, '新增语言', '600px', '570px');">
                            <div class="add">
                        ...
                        <tr>
                            ...
                            <td class="operation">
                                <div class="w150 tc">
                                    ...
                                    <a href="javascript:void(0);" data-href="<?php echo url('Language/edit',array('id'=>$vo['id'])); ?>" onclick="openFullframe(this, '编辑语言', '600px', '570px');" class="btn blue">编辑</a>
                                    <?php endif; if($vo['is_home_default'] == 1 || $vo['mark'] == $main_lang): ?>
                                        <i></i>
                                    ...
                                    <?php else: ?>
                                        <i></i>
                                        <a class="btn blue" href="javascript:void(0);" data-id="<?php echo $vo['id']; ?>" data-name="<?php echo $languagemarkList[$vo['mark']]['cn_title']; ?>" onClick="sync_arc(this);">同步</a>
...
<script>
    ...
    function sync_arc(obj) {
        ...
        var sync_arc_tip = layer.confirm('一键同步和中文主站有关联的栏目文档，<span class="red">全部同步</span>将清空<span class="red">【'+lname+'】</span>语言下所有原文档', {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo url('Language/sync', ['_ajax'=>1]); ?>",
