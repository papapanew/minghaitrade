...
/*退回文档URl*/
$archives_index_reback_arr = array();
if ($main_lang == $admin_lang) {
    $archives_index_reback_arr = array(
        'is_menu' => 1,
        'is_modules' => 1,
...
/*html生成*/
$seo_build_arr = array();
if (2 == tpCache('seo.seo_pseudo') && $main_lang == $admin_lang) {
    $seo_build_arr = array(
        'is_menu' => 0,
        'is_modules' => 1,
    );
    ...
    '1000'=>array(
        ...
        'child'=>array(
            ...
            /*'1006' => array(
                ...
                'icon'=>'iconfont e-tougao',
                'grade'=>1,
                'is_menu'=>isset($archives_index_reback_arr['is_menu']) ? $archives_index_reback_arr['is_menu'] : 0,
                'is_modules'=>isset($archives_index_reback_arr['is_modules']) ? $archives_index_reback_arr['is_modules'] : 0,
                'is_subshowmenu'=>0,
                'child' => array(),
            ),*/
            '1003' => array(
            ...
            '2004' => array(
                ...
                'child' => array(
                    ...
                    '2004016' => array(
                        ...
                        'icon'=>'iconfont e-jingtaishengcheng',
                        'grade'=>2,
                        'is_menu'=> isset($seo_build_arr['is_menu']) ? $seo_build_arr['is_menu'] : 0,
                        'is_modules'=> isset($seo_build_arr['is_modules']) ? $seo_build_arr['is_modules'] : 0,
                        'is_subshowmenu'=>0,
                        'child' => array(),
                    ),
                    '2004017' => array(
