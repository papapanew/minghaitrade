...
return array(
    'mysql' => [
        ...
        '2002:0'        => "连接数据库失败，请点击：<a href='https://www.eyoucms.com/plus/view.php?aid=31479' target='_blank'>查看教程</a>",
        ...
        '42000:1055'    => "数据库sql_mode模式对GROUP BY聚合操作，请点击：<a href='https://www.eyoucms.com/plus/view.php?aid=31458' target='_blank'>查看教程</a>",
        ...
        'HY000:1615'    => "由于个别空间的数据库配置问题，请点击：<a href='https://www.eyoucms.com/ask/list_1_7/3771.html' target='_blank'>查看教程</a>",
        'HY000:2000'    => "数据库配置不对，请查看配置文件 application/database.php 里信息是否正确。",
        'HY000:2002'    => "你的主机不支持 localhost 连接数据，导致报错，请点击：<a href='https://www.eyoucms.com/plus/view.php?aid=31480' target='_blank'>查看教程</a>",
        'HY000:2013'    => "可能MySQL服务器不支持127.0.0.1连接，请点击：<a href='https://www.eyoucms.com/plus/view.php?aid=31481' target='_blank'>查看教程</a>",
